...
class idRenderModelManagerLocal : public idRenderModelManager {
 public:
  ...
  idRenderModelManagerLocal& operator=(const idRenderModelManagerLocal&) =
      default;
  ...
  std::shared_ptr<idRenderModel> FindModel(
 ...
 private:
  ...
  std::shared_ptr<idRenderModel> GetModel(const std::string& modelName,
...
std::shared_ptr<idRenderModel> idRenderModelManagerLocal::FindModel(
    const std::string& modelName) {
  return GetModel(modelName, true);
}

std::shared_ptr<idRenderModel>
idRenderModelManagerLocal::DefaultModel() noexcept {
  return defaultModel;
}
...
std::shared_ptr<idRenderModel> idRenderModelManagerLocal::GetModel(
    const std::string& modelName, bool createIfNotFound) {
