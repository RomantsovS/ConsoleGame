...
==================
*/
std::shared_ptr<idImage> idImageManager::ImageFromFunction(
...
==============
*/
std::shared_ptr<idImage> idImageManager::ImageFromFile(
    const std::string& _name) {
...
===============
*/
void idImageManager::Shutdown() noexcept { images.clear(); }