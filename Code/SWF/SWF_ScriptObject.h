...
/*
========================
An object in an action script is a collection of variables. functions are also
variables.
========================
*/
class idSWFScriptObject
    : public std::enable_shared_from_this<idSWFScriptObject> {
 public:
  idSWFScriptObject();
  ~idSWFScriptObject();
  ...
  void SetSprite(std::shared_ptr<idSWFSpriteInstance> s) noexcept {
    objectType = swfObjectType_t::SWF_OBJECT_SPRITE;
    data.sprite = s;
  }
  std::shared_ptr<idSWFSpriteInstance> GetSprite() noexcept {
    return (objectType == swfObjectType_t::SWF_OBJECT_SPRITE)
               ? data.sprite.lock()
               : nullptr;
  }

  void SetText(std::shared_ptr<idSWFTextInstance> t) noexcept {
    objectType = swfObjectType_t::SWF_OBJECT_TEXT;
    data.text = t;
  }
  std::shared_ptr<idSWFTextInstance> GetText() noexcept {
    return data.text.lock();
  }
  ...
  idSWFScriptVar GetNestedVar(const char* arg1, const char* arg2 = NULL,
                              const char* arg3 = NULL, const char* arg4 = NULL,
                              const char* arg5 = NULL, const char* arg6 = NULL);
  std::shared_ptr<idSWFScriptObject> GetNestedObj(const char* arg1,
                                                  const char* arg2 = NULL,
                                                  const char* arg3 = NULL,
                                                  const char* arg4 = NULL,
                                                  const char* arg5 = NULL,
                                                  const char* arg6 = NULL);
  std::shared_ptr<idSWFSpriteInstance> GetNestedSprite(const char* arg1,
                                                       const char* arg2 = NULL,
                                                       const char* arg3 = NULL,
                                                       const char* arg4 = NULL,
                                                       const char* arg5 = NULL,
                                                       const char* arg6 = NULL);
  std::shared_ptr<idSWFTextInstance> GetNestedText(const char* arg1,
                                                   const char* arg2 = NULL,
                                                   const char* arg3 = NULL,
                                                   const char* arg4 = NULL,
                                                   const char* arg5 = NULL,
 ...
 private:
  ...
  struct guiObjectData_t {
    std::weak_ptr<idSWFSpriteInstance>
        sprite;  // only valid if objectType == SWF_OBJECT_SPRITE
    std::weak_ptr<idSWFTextInstance>
        text;  // only valid if objectType == SWF_OBJECT_TEXT
  } data;
