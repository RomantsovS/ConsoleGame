...
========================
*/
inline std::byte* idBitMsg::GetWriteData() { return writeData; }
...
========================
*/
inline const std::byte* idBitMsg::GetReadData() const { return readData; }
...
========================
*/
inline int idBitMsg::GetNumBytesWritten() const { return curSize; }
...
========================
*/
inline int idBitMsg::GetNumBytesRead() const { return readCount; }
...
========================
*/
inline void idBitMsg::WriteUShort(uint16_t c) { WriteBytes(c, 2); }
...
========================
*/
inline void idBitMsg::WriteLong(int32_t c) { WriteBytes(c, 4); }
...
========================
*/
inline int idBitMsg::ReadByte() const { return ReadBytes(1); }

inline uint16_t idBitMsg::ReadUShort() const { return ReadBytes(2); }

inline uint32_t idBitMsg::ReadLong() const { return ReadBytes(4); }
