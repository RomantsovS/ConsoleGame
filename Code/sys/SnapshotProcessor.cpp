...
========================
*/
bool idSnapshotProcessor::ApplyDeltaToSnapshot(idSnapShot& snap, int& outSeq, int& outBaseSeq, const std::byte* deltaMem, int deltaSize) {
...
========================
*/
void idSnapshotProcessor::SubmitPendingSnap(std::byte* objMemory, size_t objMemorySize) {
...
========================
*/
bool idSnapshotProcessor::ReceiveSnapshotDelta(const std::byte* deltaData, int deltaLength, int& outSeq, int& outBaseSeq, idSnapShot& outSnap, bool& fullSnap) {
	...
	fullSnap = ApplyDeltaToSnapshot(outSnap, outSeq, outBaseSeq, deltaData, deltaLength);
