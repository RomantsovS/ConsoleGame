...
public:
	...
	bool ApplyDeltaToSnapshot(idSnapShot& snap, int& outSeq, int& outBaseSeq, const std::byte* deltaMem, int deltaSize);
	...
	bool ReceiveSnapshotDelta(const std::byte* deltaData, int deltaLength, int& outSeq, int& outBaseSeq, idSnapShot& outSnap, bool& fullSnap);
