...
enum sysEventType_t {
  ...
  SE_MOUSE_ABSOLUTE,  // evValue and evValue2 are absolute coordinates in the
                      // window's client area.
  SE_MOUSE_LEAVE,     // evValue and evValue2 are meaninless, this indicates the
...
/*
================================================
The first part of this table maps directly to Direct Input scan codes (DIK_*
from dinput.h) But they are duplicated here for console portability
================================================
*/
enum class keyNum_t {
  K_NONE,
...
// This really isn't the right place to have this, but since this is the 'top
// level' include and has a function signature with 'FILE' in it, it kinda needs
// to be here =/
