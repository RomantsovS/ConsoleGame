...
idCVar net_verboseSnapshot("net_verboseSnapshot", "0",
                           CVAR_INTEGER | CVAR_NOCHEAT,
                           "Verbose snapshot code to help debug snapshot "
...
========================
*/
idSnapShot::idSnapShot() : time(0), recvTime(0) {}
...
========================
*/
bool idSnapShot::ReadDeltaForJob(const std::byte* deltaMem, int deltaSize,
                                 int& outSeq, int& outBaseSeq) {
...
========================
*/
idSnapShot::objectState_t* idSnapShot::S_AddObject(int objectNum,
                                                   const std::byte* data,
                                                   int _size) {
  uint32_t size = _size;
...
========================
*/
int idSnapShot::GetObjectMsgByIndex(int i, idBitMsg& msg,
                                    bool ignoreIfStale) const {
