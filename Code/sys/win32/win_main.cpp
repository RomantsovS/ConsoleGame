...
==================
*/
int Sys_AllocHook(int nAllocType, void* pvData, size_t nSize, int nBlockUse,
  ...
  switch (nAllocType) {
    ...
    case _HOOK_FREE:
      idassert(pHead->gap[0] == 0xfd && pHead->gap[1] == 0xfd &&
  ...
  fprintf(logFile,
          ...
          szFileName, nLine, operation[nAllocType], nSize, blockType[nBlockUse],
          lRequest);
  if (pvData != NULL) fprintf(logFile, " at %p\n", pvData);
...
================
*/
void Sys_ClearEvents() noexcept { eventHead = eventTail = 0; }
...
int main(int argc, const char* const* argv) {
  ...
  char timeStr[TIME_STR_LENGTH], dateStr[DATE_STR_LENGTH];         // Used to
  set up log file
