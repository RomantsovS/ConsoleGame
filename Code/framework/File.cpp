...
=================
*/
const std::string idFile::GetFullPath() const { return ""; }
...
=================
*/
int idFile::Length() const noexcept { return 0; }
...
=================
*/
ID_TIME_T idFile::Timestamp() const noexcept { return 0; }
...
=================
*/
idFile_Permanent::idFile_Permanent(const std::filesystem::path& file_name,
                                   std::ios_base::openmode ios_mode)
    : fullPath(file_name), o(file_name, ios_mode) {
#ifdef DEBUG_PRINT_Ctor_Dtor
  common->DPrintf("%s ctor\n", "idFile_Permanent");
#endif  // DEBUG_PRINT_Ctor_Dtor
}
...
int idFile_Permanent::Read(void* buffer, int len) {
  ...
  while (remaining) {
    ...
    if (!o) {
      common->Warning(
          "idFile_Permanent::Read failed with %d from %s. Trying to read %d, "
          "read %d",
...
=================
*/
void idFile_Permanent::ForceFlush() noexcept { o.flush(); }
...
=================
*/
void idFile_Permanent::Flush() noexcept { o.flush(); }
...
================
*/
int idFile_Permanent::Length() const noexcept { return fileSize; }
...
Destructor that will destroy (close) the managed file when this wrapper class
goes out of scope.
========================
*/
idFileLocal::~idFileLocal() {
