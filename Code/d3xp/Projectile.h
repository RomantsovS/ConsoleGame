...
class idProjectile : public idEntity {
 public:
  ...
  virtual void Launch(const Vector2& start, const Vector2& dir,
  ...
  static void CacheProjectille(const std::string& objectname,
 ...
 private:
  enum class PlayerTouchState { NONE, TOUCHED, UNTAUCHED };
