...
class idEntity : public idClass, public std::enable_shared_from_this<idEntity> {
 public:
  ...
  struct entityFlags_s {
    ...
    bool networkSync
        : 1;           // if true the entity is synchronized over the network
  ...
  // Called on clients in an MP game, does the actual interpolation for the
  // entity. This function will eventually replace ClientPredictionThink
  // completely.
 ...
 private:
  std::shared_ptr<idPhysics_Static>
      defaultPhysicsObj;  // default physics object
