...
========================
*/
void idMenuScreen_Shell_PressStart::ShowScreen() { idMenuScreen::ShowScreen(); }
...
========================
*/
void idMenuScreen_Shell_PressStart::HideScreen() { idMenuScreen::HideScreen(); }
...
========================
*/
bool idMenuScreen_Shell_PressStart::HandleAction(idWidgetAction& action,
  ...
  if (spMenuData->ActiveScreen() !=
      static_cast<int>(shellAreas_t::SHELL_AREA_START)) {
    return false;
  }
