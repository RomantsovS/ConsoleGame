...
========================
*/
void idMenuScreen_Shell_Pause::Initialize(
  ...
  if (auto spMenuData = menuData.lock()) {
    ...
    if (cmdBar) {
      ...
      if (!isDead) {
        ...
        buttonInfo->action.Set(
            widgetAction_t::WIDGET_ACTION_COMMAND,
            static_cast<int>(pauseMenuCmds_t::PAUSE_CMD_RETURN));
      }
    }
  }
...
void idMenuScreen_Shell_Pause::ShowScreen() {
  ...
  options->GetChildByIndex(index)
      ->AddEventAction(widgetEvent_t::WIDGET_EVENT_PRESS)
      .Set(widgetAction_t::WIDGET_ACTION_COMMAND,
           static_cast<int>(pauseMenuCmds_t::PAUSE_CMD_RESTART));
  index++;
  options->GetChildByIndex(index)->ClearEventActions();
  options->GetChildByIndex(index)
      ->AddEventAction(widgetEvent_t::WIDGET_EVENT_PRESS)
      .Set(widgetAction_t::WIDGET_ACTION_COMMAND,
           static_cast<int>(pauseMenuCmds_t::PAUSE_CMD_EXIT));
...
========================
*/
void idMenuScreen_Shell_Pause::HideScreen() { idMenuScreen::HideScreen(); }
...
========================
*/
void idMenuScreen_Shell_Pause::HandleExitGameBtn() { common->QuitRequest(); }
...
========================
*/
bool idMenuScreen_Shell_Pause::HandleAction(idWidgetAction& action,
