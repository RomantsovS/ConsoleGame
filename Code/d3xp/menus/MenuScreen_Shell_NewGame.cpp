...
========================
*/
void idMenuScreen_Shell_NewGame::Initialize(
...
========================
*/
void idMenuScreen_Shell_NewGame::ShowScreen() { idMenuScreen::ShowScreen(); }
...
========================
*/
void idMenuScreen_Shell_NewGame::HideScreen() { idMenuScreen::HideScreen(); }
...
========================
*/
bool idMenuScreen_Shell_NewGame::HandleAction(idWidgetAction& action,
                                              const idWidgetEvent& event,
                                              idMenuWidget* widget,
                                              bool forceHandled) {
  if (auto spMenuData = menuData.lock()) {
    if (spMenuData->ActiveScreen() !=
        static_cast<int>(shellAreas_t::SHELL_AREA_NEW_GAME)) {
      return false;
    }
  }
