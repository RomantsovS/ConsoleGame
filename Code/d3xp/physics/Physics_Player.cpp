...
================
*/
void idPhysics_PlayerBase::SetPlayerInput(
    const usercmd_t& cmd, const Vector2& forwardVector) noexcept {
  command = cmd;
}
...
================
*/
bool idPhysics_PlayerBase::Evaluate(int timeStepMSec,
                                    int endTimeMSec) noexcept {
  return false;
}
...
================
*/
bool idPhysics_PlayerBase::IsAtRest() const noexcept { return false; }
...
================
*/
void idPhysics_PlayerBase::SetOrigin(const Vector2& newOrigin,
                                     int id) noexcept {}
...
================
*/
void idPhysics_PlayerBase::Translate(const Vector2& translation,
                                     int id) noexcept {}
...
================
*/
void idPhysics_PlayerBase::SetLinearVelocity(const Vector2& newLinearVelocity,
                                             int id) noexcept {}
